...
- **aiohttp** (3.14 or newer): Async HTTP client for making API requests
- **dataclass-wizard** (1.x): JSON deserialization into typed Python objects
...
- **Ruff**: For linting and formatting the Python source
